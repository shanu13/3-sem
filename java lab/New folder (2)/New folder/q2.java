...
import java.util.Scanner;
	...
	System.out.println("Details Of Person Whose age is less than 18");
	  for(int i=0; i<10; i++){
	...
	static void Student_M(ArrayList<Student>array){
	 System.out.println("Details Of Person Whose name starts with M");
	   for(int i=0; i<10; i++){
	 ...
	 static ArrayList<Student> Deserialize() {
	  ...
	  static void SetDetails(ArrayList<Student> array){
